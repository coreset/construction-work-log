...
import type { EntryFormData, WorkType } from "../types/WorkLog.type";
...
const AddEntryModal: React.FC<AddEntryModalProps> = ({ workTypes, onClose, onSubmit }) => {
      ...
      >
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="flex-1">
              <Field label="Volume" error={errors.volume}>
                <input
                  ...
                  value={form.volume} placeholder="e.g. 24"
          ...
          <Field label="Performer" error={errors.performer}>
            <input
              type="text" value={form.performer} placeholder="e.g. Ivanov I. I."
